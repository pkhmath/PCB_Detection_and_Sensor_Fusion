...
#Eliminate the filling events in the Line-Loader
...
#==============================================================================================
#Procedure to eliminate the loading PCB detections
print('Start of defining procedure : elim_ldng_pcb :', datetime.datetime.now())
print('Version : 2019-05-22 15.35')

def elim_ldng_pcb(org_binry_sig,pcb_data_df,THRESHOLD):
    """
    Purpose : Eliminate the PCB detections whose durations are above threshold
...
#end-proc
print('End   of defining procedure : elim_ldng_pcb :', datetime.datetime.now())